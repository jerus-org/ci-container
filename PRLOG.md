...
- deps: update dependency toolkit to v7.3.0(pr [#570])
...
- deps: update docker.io/library/rust docker tag to v1.98.0(pr [#562])
- deps: update dependency wasmtime-cli to v48(pr [#563])
...
- deps: update ci-release-pipeline(pr [#554])
- deps: update ci-cargo-ecosystem(pr [#555])
...
- deps: update ci-cargo-ecosystem(pr [#552])
...
- deps: update dependency cargo-expand to v1.0.124(pr [#536])
...
- deps: update ci-release-pipeline(pr [#545])
...
- deps: update ci-release-pipeline(pr [#514])
...
- deps: update ci-release-pipeline to v0.6.24(pr [#510])
...
- deps: update docker.io/library/rust:1.96.0 docker digest to 4fd8406(pr [#501])
...
- deps: update dependency wasmtime-cli to v43.0.2(pr [#486])
- deps: update dependency toolkit to v6.2.0(pr [#487])
- deps: update dependency wasmtime-cli to v44(pr [#488])
...
- deps: update dependency cargo-binstall to v1.18.1(pr [#482])
...
- deps: update dependency gen-orb-mcp to v0.1.10(pr [#473])
- deps: update dependency toolkit to v6.1.0(pr [#474])
- deps: update docker.io/library/rust:1.94.1 docker digest to e8e2bb5(pr [#475])
...
- deps: update dependency pcu to v0.6.17(pr [#471])
...
- deps: update dependency gen-orb-mcp to v0.1.9(pr [#464])
...
- deps: update dependency cargo-expand to v1.0.121(pr [#444])

## [0.1.95] - 2026-03-16

### Changed

- chore-CI alignment and best practices(pr [#440])
...
- deps: update dependency gen-orb-mcp to v0.1.1(pr [#436])
...
- deps: update dependency pcu to v0.6.13(pr [#433])
...
- 👷 ci(circleci)-add version calculation job to release workflow(pr [#431])
...
- deps: update dependency pcu to v0.6.10(pr [#424])
...
- deps: update dependency pcu to v0.6.9(pr [#422])
...
- deps: update dependency nextsv to v0.19.29(pr [#412])
- deps: update dependency pcu to v0.6.8(pr [#413])
...
- deps: update dependency wasmtime-cli to v42.0.1(pr [#407])
- deps: update dependency nextsv to v0.19.28(pr [#410])
...
- add kdeets to final image COPY stage(pr [#394])
...
- deps: update dependency toolkit to v4.4.3(pr [#392])
...
[#486]: https://github.com/jerus-org/ci-container/pull/486
[#487]: https://github.com/jerus-org/ci-container/pull/487
[#488]: https://github.com/jerus-org/ci-container/pull/488
...
[#501]: https://github.com/jerus-org/ci-container/pull/501
...
[#535]: https://github.com/jerus-org/ci-container/pull/535
[#536]: https://github.com/jerus-org/ci-container/pull/536
[#537]: https://github.com/jerus-org/ci-container/pull/537
...
[#562]: https://github.com/jerus-org/ci-container/pull/562
...
[#570]: https://github.com/jerus-org/ci-container/pull/570
