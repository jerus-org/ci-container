...
FROM docker.io/library/rust:1.95.0@sha256:a9cfb755b33f5bb872610cbdb25da61f527416b28fc9c052bbce4bef93e7799a AS installer
# renovate: datasource=crate depName=cargo-binstall packageName=cargo-binstall versioning=semver-coerced
ENV CARGO_BINSTALL_VERSION=1.19.0
...
FROM docker.io/library/rust:1.95.0@sha256:a9cfb755b33f5bb872610cbdb25da61f527416b28fc9c052bbce4bef93e7799a AS base
...
FROM docker.io/library/rust:1.95.0@sha256:a9cfb755b33f5bb872610cbdb25da61f527416b28fc9c052bbce4bef93e7799a AS audit
ARG RELEASE_VERSION="dev"
ARG VCS_REF="unknown"
ARG BUILD_DATE="unknown"
ENV CI_RUST_IMAGE_VERSION=${RELEASE_VERSION}
