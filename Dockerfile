...
FROM docker.io/library/rust:1.97.1@sha256:3382bd20aa942806c533e9a73cd000474fb3ef173f71e684cc9b942675781769 AS installer
...
FROM docker.io/library/rust:1.97.1@sha256:3382bd20aa942806c533e9a73cd000474fb3ef173f71e684cc9b942675781769 AS base
...
FROM docker.io/library/rust:1.97.1@sha256:3382bd20aa942806c533e9a73cd000474fb3ef173f71e684cc9b942675781769 AS audit
ARG RELEASE_VERSION="dev"
ARG VCS_REF="unknown"
ARG BUILD_DATE="unknown"
ENV CI_RUST_IMAGE_VERSION=${RELEASE_VERSION}
