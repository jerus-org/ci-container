...
FROM docker.io/library/rust:1.96.0@sha256:58fe97504a0e4cbba5d85599619a589923d3e779472a6fb0840d58d1c4ba99d7 AS installer
...
ENV CARGO_NEXTEST_VERSION=0.9.138
...
ENV GEN_CHANGELOG_VERSION=0.1.9
...
ENV GEN_ORB_MCP_VERSION=0.1.49
RUN \
...
FROM docker.io/library/rust:1.96.0@sha256:58fe97504a0e4cbba5d85599619a589923d3e779472a6fb0840d58d1c4ba99d7 AS base
...
FROM docker.io/library/rust:1.96.0@sha256:58fe97504a0e4cbba5d85599619a589923d3e779472a6fb0840d58d1c4ba99d7 AS audit
ARG RELEASE_VERSION="dev"
ARG VCS_REF="unknown"
ARG BUILD_DATE="unknown"
ENV CI_RUST_IMAGE_VERSION=${RELEASE_VERSION}
