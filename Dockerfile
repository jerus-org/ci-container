...
FROM docker.io/library/rust:1.98.1@sha256:9234385969911ca1f0fbf293f2290c03cd3827381b68681144090f1316cbb123 AS installer
...
FROM docker.io/library/rust:1.98.1@sha256:9234385969911ca1f0fbf293f2290c03cd3827381b68681144090f1316cbb123 AS base
...
FROM docker.io/library/rust:1.98.1@sha256:9234385969911ca1f0fbf293f2290c03cd3827381b68681144090f1316cbb123 AS audit
ARG RELEASE_VERSION="dev"
ARG VCS_REF="unknown"
ARG BUILD_DATE="unknown"
ENV CI_RUST_IMAGE_VERSION=${RELEASE_VERSION}
